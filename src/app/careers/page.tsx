            ...
            <div className="relative z-10">
                ...
                <section className="pt-40 pb-12 px-6">
                    <div className="container mx-auto max-w-5xl text-center text-white">
                        ...
                        <div className="text-base text-gray-200 leading-relaxed max-w-3xl mx-auto space-y-4 font-light">
                            <p>
                ...
                <section className="pb-24 px-6">
                    <div className="container mx-auto max-w-3xl text-center">
                        <h2 className="text-white font-medium tracking-[0.3em] mb-12 uppercase">
                            Apply
                        </h2>
                        ...
                        <div className="flex flex-col items-center">
                            <a
                                ...
                                className="group relative inline-flex items-center justify-center w-24 h-24 mb-8 rounded-full border border-white/20 hover:border-white hover:bg-white transition-all duration-500"
                            ...
                            <div className="space-y-2 text-gray-400 text-sm tracking-widest uppercase mb-12">
                                <p>Click the icon to apply</p>
                            </div>

                            <div className="max-w-md mx-auto text-left">
                                <p className="text-white text-sm uppercase tracking-widest mb-6 text-center border-b border-white/10 pb-4">
                                    Please Include
                                </p>
                                <ul className="space-y-4 text-gray-300 font-light">
                                    ...
                                    <li className="flex items-baseline gap-4">
                                        <span className="text-xs text-white/50">05</span>
                                        <span>CV / Resume</span>
                                    </li>
                                </ul>
                            </div>
